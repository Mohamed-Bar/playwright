...
test.describe('SauceDemo - Authentication Module', () => {
    ...
    test('AUTH-001: Valid Login with Standard User', async ({ page }) => {
        ...
        await loginPage.takeScreenshot('./tests/screenshots/saucedemo-auth-001-login-form.png');
        ...
        await loginPage.takeScreenshot('./tests/screenshots/saucedemo-auth-001-inventory-page.png');
    });
    ...
    test('AUTH-002: Invalid Username Login', async ({ page }) => {
        ...
        await loginPage.takeScreenshot('./tests/screenshots/saucedemo-auth-002-invalid-credentials.png');
        ...
        await loginPage.takeScreenshot('./tests/screenshots/saucedemo-auth-002-error-message.png');
    });
    ...
    test('AUTH-003: Locked Out User Login', async ({ page }) => {
        ...
        await loginPage.takeScreenshot('./tests/screenshots/saucedemo-auth-003-locked-out.png');
    });
    ...
    test('AUTH-004: Empty Fields Validation', async ({ page }) => {
        ...
        await loginPage.takeScreenshot('./tests/screenshots/saucedemo-auth-004-empty-fields.png');
    });
    ...
    test('AUTH-005: Password Field Security', async ({ page }) => {
        ...
        await loginPage.takeScreenshot('./tests/screenshots/saucedemo-auth-005-masked-password.png');
    });
    ...
    test('AUTH-006: Performance User Login Flow', async ({ page }) => {
        ...
        // Note: Performance user should be slower, but exact timing may vary
        console.log('Performance user completed login flow');
        expect(loadTime).toBeGreaterThan(0); // Just verify it completed
        
        // Take screenshot of loaded inventory
        await loginPage.takeScreenshot('./tests/screenshots/saucedemo-auth-006-performance-user.png');
    });
